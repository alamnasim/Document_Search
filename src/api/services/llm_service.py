...
class LLMService:
    ...
    def __init__(self):
        ...
        print(f"✅ LLMService initialized: {self.model_name} at {self.endpoint}")
...
Include any tables, lists, and structured content."""
    ...
    def extract_text_from_image(self, file_content: bytes, file_name: str) -> Dict[str, Any]:
        """
...
If there are tables or structured layouts, preserve them."""
            ...
            print(f" Error extracting text from image {file_name}: {e}")
            return {
                "content": "",
                "success": False,
                "error": str(e)
